A Hash Map (also known as Hash Table) is a data structure that stores key-value pairs. It allows fast access, insertion, and deletion of values based on keys.
